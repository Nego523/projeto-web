...
class AlunoAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_aluno_change', args=[obj.pk])
    ...
    def display_boletins(self, obj):
        ...
        for b in boletins:
            ...
            edit_url = reverse('admin:importacao_boletim_change', args=[composite_pk])
...
class BoletimAdmin(admin.ModelAdmin):
    ...
    def response_change(self, request, obj):
        aluno_url = reverse('admin:importacao_aluno_change', args=[obj.aluno_matricula.pk])
...
class TurmaAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_turma_change', args=[obj.composite_pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class SerieAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_serie_change', args=[obj.pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class DisciplinaAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_disciplina_change', args=[obj.pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class AlunoTurmaAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_alunoturma_change', args=[obj.composite_pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class DisciplinaCursoSerieAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_disciplinacursoserie_change', args=[obj.composite_pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class AreaDoConhecimentoAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_areadoconhecimento_change', args=[obj.pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class CursoAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_curso_change', args=[obj.pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
...
class TurnoAdmin(admin.ModelAdmin):
    ...
    def edit_link(self, obj):
        url = reverse('admin:importacao_turno_change', args=[obj.pk])
        return format_html('<a href="{}">Editar</a>', url)
    edit_link.short_description = "Ações"
from django.contrib import admin
